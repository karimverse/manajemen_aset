...
<head>
    ...
    {{-- Pastikan title dan favicon sudah benar --}}
    <title>Manajemen Aset - IMST</title>
    <link rel="icon" href="{{ asset('favicon.ico') }}" type="image/x-icon">

    @vite(['resources/css/app.css', 'resources/js/app.js'])

    {{-- === STYLE BARU UNTUK LAYOUT LOGIN DUA KOLOM === --}}
    <style>
        body {
...
<body class="font-sans text-gray-900 antialiased">
    ...
    {{-- Card Login Utama (Menggantikan .guest-container) --}}
    <div class="login-card">
        ...
        <div class="login-right-column">
            {{-- Logo IMST --}}
            <img src="{{ asset('logo-imst.png') }}" alt="PT. IMST Logo" class="login-logo">

            {{-- Judul dan Subjudul akan di-render oleh $slot --}}
            {{-- <h2 class="login-title">Masuk dan Verifikasi</h2> --}}
            {{-- <p class="login-subtitle">...</p> --}}

            {{-- Di sini isi form login/register/forgot akan masuk --}}
            {{ $slot }}
