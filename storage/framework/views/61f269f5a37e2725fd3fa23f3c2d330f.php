...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.auth-session-status','data' => ['class' => 'mb-4','status' => session('status'),'style' => 'color: #28a745; background-color:#d4edda; border: 1px solid #c3e6cb; padding: 0.75rem 1rem; border-radius: 0.25rem; margin-bottom: 1rem;']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mb-4','status' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(session('status')),'style' => 'color: #28a745; background-color:#d4edda; border: 1px solid #c3e6cb; padding: 0.75rem 1rem; border-radius: 0.25rem; margin-bottom: 1rem;']); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('email')),'class' => 'mt-2 input-error']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
